...
{\Large Ond\v{r}ej Kubánek} \setlength{\parskip}{2.9cm}
...
\vspace*{4.5cm}
\oneLineTitle\\
Ond\v{r}ej Kubánek \setlength{\parskip}{1cm}

\copyright ~ Ond\v{r}ej Kubánek, \the\year. \setlength{\parskip}{1cm}

Supervisor: András Kovács, Department of Computer Science and Engineering \\
Examiner: Thierry Coquand, Department of Computer Science and Engineering \setlength{\parskip}{1cm}
