...
\newcommand{\oneLineTitle}{Canonicity of the Mahlo Universe}
\newcommand{\multiLineTitle}[1]{Canonicity of the Mahlo Universe}
...
\input{include/Canonicity}

\input{include/mahloCanon}
% CONCLUSION
